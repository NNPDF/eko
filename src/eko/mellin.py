...
def get_path_Cauchy_tan(g: t_float = 1.0, re_offset=0.0):
    """
        Get Cauchy-distribution like path - extended wia tan to the infinite domain.

        .. math::
            p_{\\text{c}}(t) = o + \\frac{\\gamma}{u^2 + \\gamma^2} + u\\cdot i

        with :math:`u = \\tan(\\pi \\cdot (2t - 1)/2)`
