...
def gamma_ns_nf3(n, sx):
    r"""Implement the common part proportional to :math:`nf^3` of :math:`\\gamma_{ns,+}^{(3)},\\gamma_{ns,-}^{(3)},\\gamma_{ns,v}^{(3)}`.
...
def gamma_nsm_nf2(n, sx):
    r"""Implement the parametrized valence-like non-singlet part proportional to :math:`nf^2`.
...
def gamma_nsm_nf1(n, sx):
    r"""Implement the parametrized valence-like non-singlet part proportional to :math:`nf^1`.
...
def gamma_nsm_nf0(n, sx):
    r"""Implement the parametrized valence-like non-singlet part proportional to :math:`nf^0`.
