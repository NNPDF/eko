...
def A_qqNS(n, sx, nf, L, eta):
    ...
    if eta == 1:
        a_qqNS_l0_nf0_param = (
            147.33794258157258
            + 113.98949756819243 / n
            - 281.2967371592745 / (1.0 + n)
            + 38.70579950086505 / (2.0 + n)
            + 0.9955738688170274 / (3.0 + n)
            - (145.39415885207825 * S1) / np.power(n, 2)
            - (171.29262522820886 * S1) / n
            + (1.1468278258573101 * S1) / np.power(1.0 + n, 4)
            - (2.272990363578042 * S1) / np.power(1.0 + n, 3)
            + (19.90921212134253 * S1) / np.power(1.0 + n, 2)
            - (113.27307570054464 * S1) / (1.0 + n)
            + (52.06671461197648 * np.power(S1, 2)) / np.power(n, 2)
            + (52.06671461197648 * S2) / np.power(n, 2)
            - (21.754329367235503 * S2) / n
            + (104.13342922395296 * S1 * S2) / n
            + (104.13342922395296 * S3) / n
            - 44.95478113831161 * lm11(n, S1)
            - 23.407257806972616 * lm12(n, S1, S2)
            + 8.35410731114661 * lm13(n, S1, S2, S3)
        )
    else:
        a_qqNS_l0_nf0_param = (
            147.3378589908694
            - 16.562929736076484 / n
            - 111.14416242203112 / (1.0 + n)
            + 31.213717535206744 / (2.0 + n)
            - 8.779870339791112 / (3.0 + n)
            - (22.17178453961169 * S1) / np.power(n, 2)
            - (72.57353706844546 * S1) / n
            - (4.5221993797652855 * S1) / np.power(1.0 + n, 4)
            + (11.046972796424692 * S1) / np.power(1.0 + n, 3)
            + (1.020295601323685 * S1) / np.power(1.0 + n, 2)
            - (74.34971914835894 * S1) / (1.0 + n)
            + (22.05971003065791 * np.power(S1, 2)) / np.power(n, 2)
            + (22.05971003065791 * S2) / np.power(n, 2)
            - (5.612139412665198 * S2) / n
            + (44.11942006131582 * S1 * S2) / n
            + (44.11942006131582 * S3) / n
            - 13.193984654883048 * lm11(n, S1)
            - 24.18485568404457 * lm12(n, S1, S2)
            + 8.324473013764225 * lm13(n, S1, S2, S3)
        )
