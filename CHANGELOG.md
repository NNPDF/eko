...
### Changed
- py: Drop support for Python 3.9 ([#490](https://github.com/NNPDF/eko/pull/490))
...
- py: Add support for Python 3.13, lift minimum NumPy version to 2 ([#470](https://github.com/NNPDF/eko/pull/470))
