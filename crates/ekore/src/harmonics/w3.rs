...
pub(super) fn Sm3o(c: &mut Cache) -> Complex<f64> {
    let hS3 = c.get(K::S3);
...
pub(super) fn Sm21e(c: &mut Cache) -> Complex<f64> {
...
pub(super) fn Sm21o(c: &mut Cache) -> Complex<f64> {
