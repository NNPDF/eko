...
/// Compute the LO QCD non-singlet anomalous dimension.
///
...
/// Compute the LO QCD quark-gluon anomalous dimension.
///
...
/// Compute the LO QCD gluon-quark anomalous dimension.
///
/// Implements Eq. (3.5) of [\[Vogt:2004mw\]](crate::bib::Vogt2004mw).
...
/// Compute the LO QCD gluon-gluon anomalous dimension.
///
/// Implements Eq. (3.5) of [\[Vogt:2004mw\]](crate::bib::Vogt2004mw).
...
/// Compute the LO QCD singlet anomalous dimension matrix.
