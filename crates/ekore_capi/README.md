...
C API for the [ekore](https://crates.io/crates/ekore) crate which is a part of the [EKO](https://github.com/NNPDF/eko) framework.
...
For installation instructions and usage see the documentation: [![docs.rs](https://docs.rs/ekore_capi/badge.svg)](https://docs.rs/ekore_capi/)
