...
def test_nsp():
    ...
    for i in range(3):
        np.testing.assert_almost_equal(ad_as2.gamma_nsp(Nlist[i], NF), res[i])
...
def test_nsm():
    ...
    for i in range(3):
        np.testing.assert_almost_equal(ad_as2.gamma_nsm(Nlist[i], NF), res[i])
...
def test_qg():
    ...
    for i in range(3):
        np.testing.assert_almost_equal(ad_as2.gamma_qg(Nlist[i], NF), res[i])
...
def test_gq():
    ...
    for i in range(3):
        np.testing.assert_almost_equal(ad_as2.gamma_gq(Nlist[i], NF), res[i])
...
def test_gg():
    ...
    for i in range(3):
        np.testing.assert_almost_equal(ad_as2.gamma_gg(Nlist[i], NF), res[i])
