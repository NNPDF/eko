...
def test_gamma_1():
    # number conservation
    sx_n1 = h.sx(1, 2)
    sx_new1 = h.compute_additional_sx_cache(1, False, False, sx_n1)
    np.testing.assert_allclose(ad_as2.gamma_nsm(1, NF, sx_n1, sx_new1), 0.0, atol=2e-6)

    sx_n2 = h.sx(2, 2)
    sx_new2 = h.compute_additional_sx_cache(2, True, False, sx_n2)
    ...
    np.testing.assert_allclose(
        ad_as2.gamma_nsp(2, NF, sx_n2, sx_new2),
    ...
    sx_new2 = h.compute_additional_sx_cache(2, False, False, sx_n2)
    np.testing.assert_allclose(
    ...
    sx_n3 = h.sx(3, 2)
    sx_n4 = h.sx(4, 2)
    sx_new3 = h.compute_additional_sx_cache(3, True, False, sx_n3)
    sx_new4 = h.compute_additional_sx_cache(4, True, False, sx_n4)
    np.testing.assert_allclose(
    ...
    gS1 = ad_as2.gamma_singlet(3, NF, sx_n3, sx_new3)
    np.testing.assert_allclose(
        gS1[1, 0],
        (
    ...
    gS1 = ad_as2.gamma_singlet(4, NF, sx_n4, sx_new4)
    np.testing.assert_allclose(
